...
rm -rf dMagnetic_0.19.tar.bz2
rm -rf dmagnetic_0.19.orig.tar.gz
rm -rf dmagnetic-0.19



wget -c https://www.dettus.net/dMagnetic/dMagnetic_0.19.tar.bz2
tar xvfj dMagnetic_0.19.tar.bz2
mv dMagnetic_0.19 dmagnetic-0.19
tar cvfz dmagnetic_0.19.orig.tar.gz dmagnetic-0.19
tar cvfJ dmagnetic_0.19-1.debian.tar.xz debian
...
###echo "Checksums-Sha1:"
###for I in dmagnetic_0.19.orig.tar.gz dmagnetic_0.19-1.debian.tar.xz
###do
...
debuild
cd ..
debsign dmagnetic_0.19-1_amd64.changes
#dh_make
