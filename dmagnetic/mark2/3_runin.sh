...
scp -i ../../VM_based/Keys/ssh-keyfile -P 2001 root@localhost:package_out.patch openbsd_d11amp061.patch
scp -i ../../VM_based/Keys/ssh-keyfile -P 2002 root@localhost:package_out.patch freebsd_d11amp061.patch
scp -i ../../VM_based/Keys/ssh-keyfile -P 2003 root@localhost:package_out.patch netbsd_d11amp061.patch
