...
scp -i ../../VM_based/Keys/ssh-keyfile -P 2001 root@localhost:package_out.patch openbsd_dmagnetic036.patch
scp -i ../../VM_based/Keys/ssh-keyfile -P 2002 root@localhost:package_out.patch freebsd_dmagnetic036.patch
scp -i ../../VM_based/Keys/ssh-keyfile -P 2003 root@localhost:package_out.patch netbsd_dmagnetic036.patch
