...
scp -i ../../VM_based/Keys/ssh-keyfile -P 2002 ports/FreeBSD/PATCHES_IN.tar.gz root@localhost:
...
scp -i ../../VM_based/Keys/ssh-keyfile -P 2003 ports/NetBSD/PATCHES_IN.tar.gz root@localhost:
