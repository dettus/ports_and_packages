...
import hashlib
prevdebianpackage="d11amp_0.01-1"
versionnum="0.58"
...
def downloadfiles(dirrepos,dirdownload,packagefilename):
	...
	cmdlist+='''
		...
		(
			mkdir NetBSD
			cd NetBSD
			cvs -q -z2 -d anoncvs@anoncvs.NetBSD.org:/cvsroot checkout -P pkgsrc/audio/
		)
		'''
	os.system(cmdlist)


	url='http://deb.debian.org/debian/pool/main/d/d11amp/'+prevdebianpackage+'.debian.tar.xz'
	...
	url='https://www.dettus.net/d11amp/'+packagefilename
...
packagefilename="d11amp_"+versionnum+".tar.bz2"
...
macroterminals['%%NEWCHANGELOG%%']="d11amp ("+versionnum+"-1) unstable; urgency=medium\n\n"+readTxtFile("newchangelog.txt")+"\n -- Thomas Dettbarn <dettus@dettus.net>  "+getnow()
